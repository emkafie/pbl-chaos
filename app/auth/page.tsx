...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-(--color-y2k-bg-main) flex items-center justify-center p-4 font-mono overflow-hidden relative selection:bg-(--color-y2k-lime) selection:text-(--color-y2k-button-text)">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[400px] h-[400px] bg-(--color-y2k-purple) opacity-10 rounded-full blur-[100px]"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-(--color-y2k-lime) opacity-10 rounded-full blur-[100px]"></div>
